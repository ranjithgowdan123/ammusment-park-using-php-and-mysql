...
//$sql = "DROP VIEW AMOUNT ;CREATE VIEW AMOUNT as SELECT DATE,sum(FARE) FROM BOOK_TICKET GROUP BY DATE";
//$result = $conn->query($sql);

if (!mysqli_query("DROP VIEW AMOUNT ;CREATE VIEW AMOUNT as SELECT DATE,sum(FARE) FROM BOOK_TICKET GROUP BY DATE")) {
  echo("Error ");
}

$sql1 = "SELECT * FROM AMOUNT";
...
<section class="engine"><a href="https://mobirise.ws/g">create your own website</a></section><section class="section-table cid-qPaWdZeHOM" id="table1-10">
      ...
      <div class="table-wrapper">
        ...
        <div class="container scroll">
          <table class="table isSearch" cellspacing="0">
            ...
            echo'
            <tr> 
              <td class="body-item mbr-fonts-style display-7">'.$row["DATE"].'</td><td class="body-item mbr-fonts-style display-7">'.$row["sum(FARE)"].'</td></tr>';
...
<section class="cid-qPaUXAIPYe" id="footer1-z">
        ...
        <div class="media-container-row content text-white">
            <div class="col-12 col-md-3">
                <div class="media-wrap">
                    <a href="https://mobirise.com/">
                        <img src="assets/images/amusement-text-192x157.png" alt="Mobirise" title="">
                    </a>
                </div>
            </div>
...
<br>BENGALURU -85</p>
            ...
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                ...
                <p class="mbr-text">Contact Us
<br>Email: support@lostworld.com 
<br>Phone: +91 81509 00077&nbsp;</p>
            </div>
            <div class="col-12 col-md-3 mbr-fonts-style display-7">
                <h5 class="pb-3">
                    Links
        ...
        <div class="footer-lower">
            ...
            <div class="media-container-row mbr-white">
                <div class="col-sm-6 copyright">
                    <p class="mbr-text mbr-fonts-style display-7"><br>© Copyright 2018 RJK - All Rights Reserved</p>
                </div>
                <div class="col-md-6">
