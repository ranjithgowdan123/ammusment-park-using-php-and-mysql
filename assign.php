    ...
    <div class="container" width="700px">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="insert_ride.php" method="post">
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-w">Staff ID</label>
                                    <input type="text" class="form-control" name="staff" data-form-field="Name" required="" id="name-form1-w">
                                </div>
                            </div>
                            
                            <div class="col-md-4 multi-horizontal" data-for="phone">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="phone-form1-w">Ride ID</label>
                                    <input type="tel" class="form-control" name="ride" data-form-field="Phone" required=""id="phone-form1-w">
                                </div>
                            </div><br><br>                       
...
<div class="container" width="700px">
        <div class="row justify-content-center">
            <div class="media-container-column col-lg-8" data-form-type="formoid">
                    ...
                    <form class="mbr-form" action="insert_kiosk.php" method="post">
                        <div class="row row-sm-offset">
                            <div class="col-md-4 multi-horizontal" data-for="name">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="name-form1-w">Staff ID</label>
                            ...
                            <div class="col-md-4 multi-horizontal" data-for="phone">
                                <div class="form-group">
                                    <label class="form-control-label mbr-fonts-style display-7" for="phone-form1-w">KIOSK ID</label>
                                    <input type="tel" class="form-control" name="kiosk" data-form-field="Phone" required=""id="phone-form1-w">
                                </div>
                            </div><br><br>                       
